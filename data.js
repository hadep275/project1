export const greetings = ["hello", "hi", "greetings"];
export const greetingsPrefix = [
...
export const greetingsResponses = [
  "How can I help you?",
...
export const FAQs = [
  "What is inceptionU?",
  "\nWhat kind of courses does InceptionU offer?",
  "\nWho is eligible to enroll in courses at InceptionU?",
  "\nHow long are the courses at InceptionU?",
  "\nWhat is the cost of the courses at InceptionU?",
  "\nIs financial assistance available for the courses at InceptionU?",
  "\nWhat are the requirements for completing a course at InceptionU?",
  "\nWhat kind of job placement assistance does InceptionU offer?",
  "\nDoes InceptionU offer online courses?",
...
export const unknown = ["failed", "try again"];
export const unknownResponse = [
  "I didn't understand. Can you please rephrase your question?",
  "I'm not sure what you mean. Can you please provide more information?",
  "I'm not programmed to understand that. Can you please ask me something else?",
  "Could you please rephrase your question?",
  "I'm not quite sure I understand. Could you provide more information or clarify?",
  ...
  "Can you please provide additional context?",
